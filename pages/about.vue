<template>
  <div class="About">
    ...
    <StaticCard>
      ...
      {{
        $t(
          '群馬県による公式情報と客観的な数値をわかりやすく伝えることで、群馬県にお住まいの方や、群馬県に拠点を持つ企業の方、群馬県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </StaticCard>
    <StaticCard>
      ...
      <p class="StaticCard-Note">
        ...
        <span>
          {{
            $t(
              '推奨環境以外で利用された場合や、推奨環境下でもご利用のブラウザの設定等によっては、正しく表示されない場合がありますのでご了承ください。（Androidの一部機種にて不具合が生じることを確認しています。）'
            )
          }}
        </span>
      </p>
    ...
    <StaticCard>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、群馬県は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
